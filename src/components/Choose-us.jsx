      ...
      <div className="max-w-[1480px] mx-auto px-8">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col justify-around items-center gap-14 w-full mt-8 text-center lg:flex-row">
            <article className="flex flex-col items-center text-center max-w-[500px] text-Black lg:text-left">
              ...
              <a href="#home" className="bg-Red text-[#fff] font-bold w-fit py-4 px-8 rounded border-2 border-solid border-Red shadow-md transition-all duration-300 hover:bg-[#fa4226] hover:shadow-lg">
                Find Details &nbsp;
