...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="flex justify-between items-center w-full h-auto py-8 px-5 mx-auto absolute top-0 left-0 right-0 z-50 lg:hidden">
        <div className="w-40">
          <Link to="/">
            <img
      ...
      <div className="hidden lg:flex justify-between items-center w-full h-auto py-6 px-8 mx-auto absolute top-0 left-0 right-0 z-50">
        ...
        <div className="flex items-center gap-6 font-Rubik text-lg font-medium">
          ...
          <Link
            to="/"
            className="bg-Red text-[#fff] py-4 px-8 rounded shadow-md transition-shadow duration-300 hover:shadow-lg"
          >
            Register
          </Link>
        </div>
